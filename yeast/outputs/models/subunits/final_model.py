...
'Am': ((0.329412, 0.360784, 0.94902), 1, u'default'), 'Al': ((0.74902, 0.65098, 0.65098), 1, u'default'), 'As': ((0.741176, 0.501961, 0.890196), 1, u'default'), 'Ar': ((0.501961, 0.819608, 0.890196), 1, u'default'), 'Au': ((1, 0.819608, 0.137255), 1, u'default'), 'Es': ((0.701961, 0.121569, 0.831373), 1, u'default'), 'In': ((0.65098, 0.458824, 0.45098), 1, u'default'), 'Mo': ((0.329412, 0.709804, 0.709804), 1, u'default')}
	...
	viewerInfo = {'cameraAttrs': {'center': (218.02325439453, 217.10005950928, 173.9509359693), 'fieldOfView': 19.154975261048, 'nearFar': (276.01735104663, 78.807308145477), 'ortho': False, 'eyeSeparation': 50.8, 'focal': 181.46114349365}, 'viewerAttrs': {'silhouetteColor': None, 'clipping': False, 'showSilhouette': False, 'showShadows': False, 'viewSize': 26.000335435226, 'labelsOnTop': True, 'depthCueRange': (0.5, 1), 'silhouetteWidth': 2, 'singleLayerTransparency': True, 'shadowTextureSize': 2048, 'backgroundImage': [None, 1, 2, 1, 0, 0], 'backgroundGradient': [('Chimera default', [(1, 1, 1, 1), (0, 0, 1, 1)], 1), 1, 0, 0], 'depthCue': True, 'highlight': 0, 'scaleFactor': 0.34439039997873, 'angleDependentTransparency': True, 'backgroundMethod': 0}, 'viewerHL': 2, 'cameraMode': 'mono', 'detail': 1.5, 'viewerFog': None, 'viewerBG': 1}
     ...
     (
      {
       ...
       'file_type': 'mrc',
       'grid_id': '',
       'name': 'tfiih_cluster_0_run3_tfb1.mrc',
       'path': 'tfiih_cluster_0_run3_tfb1.mrc',
       'rotation': (
         ( 1, 0, 0, ),
         ( 0, 1, 0, ),
         ( 0, 0, 1, ),
      ...
      [
       {
        ...
        'surface_model': {
          ...
          'display': True,
          'id': 5,
          'name': u'tfiih_cluster_0_run3_tfb1.mrc',
          'osl_identifier': u'#5',
          'silhouette': True,
          'subid': 0,
          ...
          'xform': {
            'class': 'Xform_State',
            'rotation_angle': 39.438885849902334,
            'rotation_axis': ( 0.01239078788159405, -0.0059544250322809845, 0.9999055021341808, ),
            'translation': ( 193.359741557766, -19.02776176327064, -4.259062572053574, ),
            'version': 1,
           },
         },
     ...
     (
      {
       ...
       'file_type': 'mrc',
       'grid_id': '',
       'name': 'tfiih_cluster_0_run3_tfb3.mrc',
       'path': 'tfiih_cluster_0_run3_tfb3.mrc',
       'rotation': (
         ( 1, 0, 0, ),
         ( 0, 1, 0, ),
         ( 0, 0, 1, ),
      ...
      [
       {
        ...
        'surface_model': {
          ...
          'display': True,
          'id': 7,
          'name': u'tfiih_cluster_0_run3_tfb3.mrc',
          'osl_identifier': u'#7',
          'silhouette': True,
          'subid': 0,
          'use_clip_plane': False,
     ...
     (
      {
       ...
       'file_type': 'mrc',
       'grid_id': '',
       'name': 'tfiih_cluster_0_run3_kin28.mrc',
       'path': 'tfiih_cluster_0_run3_kin28.mrc',
       'rotation': (
         ( 1, 0, 0, ),
         ( 0, 1, 0, ),
         ( 0, 0, 1, ),
      ...
      [
       {
        ...
        'surface_model': {
          ...
          'display': True,
          'id': 1,
          'name': u'tfiih_cluster_0_run3_kin28.mrc',
          'osl_identifier': u'#1',
          'silhouette': True,
          'subid': 0,
          'use_clip_plane': False,
     ...
     (
      {
       ...
       'file_type': 'mrc',
       'grid_id': '',
       'name': 'tfiih_cluster_0_run3_ssl2.mrc',
       'path': 'tfiih_cluster_0_run3_ssl2.mrc',
       'rotation': (
         ( 1, 0, 0, ),
         ( 0, 1, 0, ),
         ( 0, 0, 1, ),
      ...
      [
       {
        ...
        'surface_model': {
          ...
          'display': True,
          'id': 4,
          'name': u'tfiih_cluster_0_run3_ssl2.mrc',
          'osl_identifier': u'#4',
          'silhouette': True,
          'subid': 0,
          'use_clip_plane': False,
     ...
     (
      {
       ...
       'file_type': 'mrc',
       'grid_id': '',
       'name': 'tfiih_cluster_0_run3_ccl1.mrc',
       'path': 'tfiih_cluster_0_run3_ccl1.mrc',
       'rotation': (
         ( 1, 0, 0, ),
         ( 0, 1, 0, ),
         ( 0, 0, 1, ),
      ...
      [
       {
        ...
        'surface_model': {
          ...
          'display': True,
          'id': 0,
          'name': u'tfiih_cluster_0_run3_ccl1.mrc',
          'osl_identifier': u'#0',
          'silhouette': True,
          'subid': 0,
          'use_clip_plane': False,
     ...
     (
      {
       ...
       'file_type': 'mrc',
       'grid_id': '',
       'name': 'tfiih_cluster_0_run3_tfb4.mrc',
       'path': 'tfiih_cluster_0_run3_tfb4.mrc',
       'rotation': (
         ( 1, 0, 0, ),
         ( 0, 1, 0, ),
         ( 0, 0, 1, ),
      ...
      [
       {
        ...
        'surface_model': {
          ...
          'display': True,
          'id': 8,
          'name': u'tfiih_cluster_0_run3_tfb4.mrc',
          'osl_identifier': u'#8',
          'silhouette': True,
          'subid': 0,
          'use_clip_plane': False,
     ...
     (
      {
       ...
       'file_type': 'mrc',
       'grid_id': '',
       'name': 'tfiih_cluster_0_run3_rad3.mrc',
       'path': 'tfiih_cluster_0_run3_rad3.mrc',
       'rotation': (
         ( 1, 0, 0, ),
         ( 0, 1, 0, ),
         ( 0, 0, 1, ),
      ...
      [
       {
        ...
        'surface_model': {
          ...
          'display': True,
          'id': 2,
          'name': u'tfiih_cluster_0_run3_rad3.mrc',
          'osl_identifier': u'#2',
          'silhouette': True,
          'subid': 0,
          'use_clip_plane': False,
     ...
     (
      {
       ...
       'file_type': 'mrc',
       'grid_id': '',
       'name': 'tfiih_cluster_0_run3_ssl1.mrc',
       'path': 'tfiih_cluster_0_run3_ssl1.mrc',
       'rotation': (
         ( 1, 0, 0, ),
         ( 0, 1, 0, ),
         ( 0, 0, 1, ),
      ...
      [
       {
        ...
        'surface_model': {
          ...
          'display': True,
          'id': 3,
          'name': u'tfiih_cluster_0_run3_ssl1.mrc',
          'osl_identifier': u'#3',
          'silhouette': True,
          'subid': 0,
          'use_clip_plane': False,
     ...
     (
      {
       ...
       'file_type': 'mrc',
       'grid_id': '',
       'name': 'tfiih_cluster_0_run3_tfb2.mrc',
       'path': 'tfiih_cluster_0_run3_tfb2.mrc',
       'rotation': (
         ( 1, 0, 0, ),
         ( 0, 1, 0, ),
         ( 0, 0, 1, ),
      ...
      [
       {
        ...
        'surface_levels': [ 0.07374842545511792, ],
        'surface_model': {
          'active': True,
          'class': 'Model_State',
          'clip_plane_normal': ( 0.0, 0.0, 0.0, ),
          ...
          'display': True,
          'id': 6,
          'name': u'tfiih_cluster_0_run3_tfb2.mrc',
          'osl_identifier': u'#6',
          'silhouette': True,
          'subid': 0,
          'use_clip_plane': False,
     ...
     (
      {
       ...
       'file_type': 'mrc',
       'grid_id': '',
       'name': 'tfiih_cluster_0_run3_tfb5.mrc',
       'path': 'tfiih_cluster_0_run3_tfb5.mrc',
       'rotation': (
         ( 1, 0, 0, ),
         ( 0, 1, 0, ),
         ( 0, 0, 1, ),
      ...
      [
       {
        ...
        'surface_levels': [ 0.07793029770255103, ],
        'surface_model': {
          'active': True,
          'class': 'Model_State',
          'clip_plane_normal': ( 0.0, 0.0, 0.0, ),
          ...
          'display': True,
          'id': 9,
          'name': u'tfiih_cluster_0_run3_tfb5.mrc',
          'osl_identifier': u'#9',
          'silhouette': True,
          'subid': 0,
          'use_clip_plane': False,
 ...
 volume_dialog_state = \
  {
   ...
   'data_cache_size': '512',
   'focus_volume': "ra-,9'B}uH-f\nf-%[:'nBdrGM3T!gAeM",
   'geometry': u'408x405+1256+742',
   'histogram_active_order': [ 1, 0, 2, ],
   'histogram_volumes': [ '&0Y6c=Zfs}u/Sjh."|c=QTv>=$NApr&Z', "ra-,9'B}uH-f\nf-%[:'nBdrGM3T!gAeM", 'I"kA!xcY.KK0\n.(5nx5h7kivdK)!c}j=', ],
   'immediate_update': 1,
   'initial_colors': (
     ( 0.7, 0.7, 0.7, 1, ),
     ( 1, 1, 0.7, 1, ),
